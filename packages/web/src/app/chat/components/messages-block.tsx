    ...
    <div className={cn('flex h-full flex-col', className)}>
      ...
      {!isReplay ? (
        ...
        <>
          ...
          >
            <Card className={cn('w-full transition-all duration-300', !replayStarted && 'translate-y-[-40vh]')}>
              <div className="flex items-center justify-between">
                <div className="flex-grow">
                  <CardHeader>
                    <CardTitle>
                      <RainbowText animated={responding}>{responding ? 'Replaying' : `${replayTitle}`}</RainbowText>
                    </CardTitle>
                    <CardDescription>
